...
class ArticuloCard extends StatelessWidget {
  ...
  Widget _buildContent(BuildContext context, ColorScheme colorScheme, double pesoTotal) {
    return Container(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          IconButton(
                            onPressed: cantidad > 1 && onCantidadCambiada != null
                                ? () {
                            ...
                            icon: Icon(
                              Icons.remove,
                              size: 18,
                              color: cantidad > 1 && onCantidadCambiada != null
                                  ? rcColor6
                                  : rcColor8,
                            ),
                          ...
                          IconButton(
                            onPressed: onCantidadCambiada != null
                                ? () {
                                    onCantidadCambiada?.call(cantidad + 1);
                                  }
                                : null,
                            icon: Icon(
                              Icons.add,
                              size: 18,
                              color: onCantidadCambiada != null ? rcColor6 : rcColor8,
                            ),
                            padding: EdgeInsets.zero,
                            constraints: const BoxConstraints(
                              minWidth: 32,
  ...
  Widget build(BuildContext context) {
    ...
    final content = _buildContent(context, colorScheme, pesoTotal);

    // Si onEliminar es null, no permitir deslizar para eliminar
    if (onEliminar == null) {
      return content;
    }
